...
<html>
	...
	<%
		...
		try {
			...
			final sample.AMQPMessageProducer messageProducer = (sample.AMQPMessageProducer) wac.getBean(sample.AMQPMessageProducer.class);
			out.println("messageProducer is " + messageProducer + " \n" + " about to send AMQP message at " + Calendar.getInstance().getTime().toString());
